    ...
    return new this(
      _.chain(ALL_OPTIONS)
        .filter(function (option) {
          const isAvailable = _.contains(availableOptions, option.privacy);
          const shouldBeDisabled = publicSharingIsDisabled ? option.privacy !== 'PRIVATE' : false;
          return isAvailable && !shouldBeDisabled;
        })
        .map(function (option) {
